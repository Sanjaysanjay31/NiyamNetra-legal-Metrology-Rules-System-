    ...
    return [
      {
        heading: null,
        items: [
          { to: '/admin', label: t('nav.dashboard') || 'Dashboard', icon: LayoutDashboard, end: true },
          { to: '/admin/inspections', label: t('nav.inspections') || 'Inspections', icon: ClipboardList },
          { to: '/admin/stores', label: t('nav.stores') || 'Stores', icon: Store },
          { to: '/admin/scans', label: t('nav.products') || 'Products / Scans', icon: Package },
          { to: '/admin/violations', label: t('nav.violations') || 'Violations', icon: AlertTriangle },
          { to: '/admin/repeat-offenders', label: 'Repeat Offenders', icon: TrendingUp },
          { to: '/admin/inspectors', label: t('nav.inspectors') || 'Inspectors', icon: Users },
          { to: '/admin/reports', label: t('nav.reports') || 'Reports', icon: BarChart3 },
          { to: '/admin/audit', label: t('nav.audit') || 'Audit', icon: ShieldCheck },
          { to: '/admin/rule-versions', label: t('nav.rules') || 'Rule Versions', icon: BookOpen },
  ...
  return [
    {
      heading: null,
      items: [
        { to: '/inspector', label: t('nav.home') || 'Home', icon: Home, end: true },
        { to: '/inspector/inspections', label: t('nav.inspections') || 'Inspections', icon: ClipboardList },
        { to: '/inspector/reports', label: t('nav.reports') || 'Reports', icon: FileText },
        { to: '/inspector/violations', label: t('nav.violations') || 'Violations', icon: AlertTriangle },
        { to: '/inspector/performance', label: t('nav.performance') || 'Performance', icon: Activity },
        { to: '/inspector/profile', label: 'Profile', icon: Users },
      ],
    },
    {
      heading: 'Field Actions',
      items: [
        { to: '/inspector/inspections/new', label: t('nav.newInspection') || 'New Inspection', icon: PlusCircle },
        { to: '/inspector/today', label: t('nav.today') || "Today's Summary", icon: FileText },
      ],
    },
  ]
}
